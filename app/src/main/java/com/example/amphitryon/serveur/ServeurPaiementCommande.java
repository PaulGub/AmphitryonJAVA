...
public class ServeurPaiementCommande extends AppCompatActivity {
    String responseStr ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_serveur_paiement_commande);
        ...
        Request request2 = new Request.Builder()
                .url("http://192.168.43.91/amphitryon/modeles/dao/listeCommandeNonPayer.php")
                .build();
        ...
        call2.enqueue(new Callback() {
            ...
            public  void onResponse(Call call2, Response response) throws IOException {
                ...
                try {
                    ...
                    commandeAdapter = new ArrayAdapter<>(ServeurPaiementCommande.this, android.R.layout.simple_spinner_item, commandeListe);
        ...
        buttonQuitterCommande.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ServeurPaiementCommande.this.finish();
            }
        });
    }
    ...
    public void newCommandePlat() throws IOException {
        ...
        Request request = new Request.Builder()
                .url("http://192.168.43.91/amphitryon/modeles/dao/modifPaiement.php")
                .post(formBody)
                .build();
